...
<template>
    ...
    <AppLayout>
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            ...
            <StatCard label="Zakat Payers" :value="stats.zakat_payers" />
        ...
        <div class="grid lg:grid-cols-2 gap-6">
            <div class="bg-white rounded-xl border p-6">
                <h3 class="font-semibold text-slate-800 mb-4">Donation Summary (BDT)</h3>
            ...
            <div class="bg-white rounded-xl border p-6">
                <h3 class="font-semibold text-slate-800 mb-4">Ward Population</h3>
                <div class="space-y-2 max-h-64 overflow-y-auto">
                    <div v-for="v in stats.village_population" :key="v.id" class="flex justify-between text-sm">
                        ...
                        <span class="font-medium">{{ v.residents_count }} members / {{ v.houses_count }} houses</span>
                    </div>
                </div>
            </div>
        </div>
